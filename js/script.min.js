...
app.config(['$routeProvider', '$locationProvider',
    function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.when('/about-chefonia', {
            ...
            title: 'Your all orders - Chefonia India',
            controller: 'OrdersController',
            controllerAs: 'vm',
            loginRequired: true
        }).when('/reset-password/:notificationId', {
            templateUrl: 'pages/common/reset-password.html',
            title: 'Reset your password - Chefonia India',
            controller: 'ResetPasswordController',
            controllerAs: 'vm',
        }).when('/categories', {
            templateUrl: 'pages/categories/categories.html',
            title: 'All food categories - Chefonia India',
            controller: 'CategoryController',
            controllerAs: 'vm',
        }).otherwise({
            templateUrl: 'pages/front/front.html',
            title:"Order online snacks and sweets | Up to 50% discount | Chefonia",
    ...
    run(function ($rootScope, SessionService, $location) {
        ...
        $rootScope.$on('$routeChangeSuccess', function (event, current, previous) {
            if (current.hasOwnProperty('$$route')) {
                ...
                $rootScope.title="Order online snacks and sweets | Up to 50% discount | Chefonia";
            }
        });
