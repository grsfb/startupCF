var app = angular.module('Chefonia', ['ngRoute']);
    ...
    function ($routeProvider, $locationProvider) {
        $routeProvider.
            ...
            when('/how-it-works', {
                ...
                templateUrl:'foodkart/pages/register/register.html'
            }).otherwise({
              //  templateUrl: 'pages/home/items.html',
...
app.controller("citylistctrl", function ($scope) {
    if ($scope.city == null) {
        $scope.cityList = ['Pune', 'Nagpur', 'Mumbai'];
    }
